...
import { toggleAIModel } from "../../store/slices/popupSlice";
...
const AISearchModel = () => {
  ...
  return <>
    ...
    >
      ...
      border-border rounded-2xl p-8 w-full max-w-2xl" onClick={(e)=>e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            <div
              className="w-10 h-10 bg-gradient-to-bright from-purple-500 
        ...
        <form onSubmit={handleSearch} className="space-y-6">
          ...
          <button
            ...
            className={`w-full py-4 bg-gradient-to-right from-purple-500 to-blue-500 text-white rounded-lg 
