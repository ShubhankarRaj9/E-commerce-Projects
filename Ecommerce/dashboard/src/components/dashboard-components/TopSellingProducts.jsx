...
const TopSellingProducts = () => {
  ...
  <div className="bg-white rounded-xl p-6 shadow-md overflow-x-auto xl:col-span-2 max-h-[440px] scroolbar-hide">
    ...
    <tbody>
      {
        topSellingProducts.length>0 && topSellingProducts.map((element,index)=>{
          return(
            <tr key={index} className="border-b hover:bg-gray-50 tranistion">
              <td className="px-4 py-3">
                <img src={element.image} alt={element.name} className="w-12 h-12 object-cover rounded-md"/>
              </td>
