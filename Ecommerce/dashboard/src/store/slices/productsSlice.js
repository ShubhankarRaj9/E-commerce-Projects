...
import { toggleCreateProductModel, toggleUpdateProductModel } from "./extraSlice";
...
export const createNewProduct=(data) => async (dispatch)=>{
  ...
  await axiosInstance.post("/product/admin/create",data).then(
    res => {
...
export const updateProduct=(data,id) => async (dispatch)=>{
  ...
  await axiosInstance.put(`/product/admin/update/${id}`,data).then(
    res => {
...
export const deleteProduct=(id) => async (dispatch,getState)=>{
  ...
  await axiosInstance.delete(`/product/admin/delete/${id}`).then(
    res => {
